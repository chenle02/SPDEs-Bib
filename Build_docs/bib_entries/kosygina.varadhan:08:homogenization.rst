kosygina.varadhan:08:homogenization
===================================
...
.. code-block:: bibtex
   ...
   @article{kosygina.varadhan:08:homogenization,
    ...
    number = {6},
    pages = {816--847},
    title = {Homogenization of {H}amilton-{J}acobi-{B}ellman equations
   with respect to time-space shifts in a stationary ergodic
   medium},
...
`The URL link to the source <ttps://doi.org/10.1002/cpa.20220}>`__
