...
.. code-block:: bibtex
   ...
   @article{winkler:19:does,
    ...
    title = {Does repulsion-type directional preference in chemotactic
   migration continue to regularize {K}eller-{S}egel systems
   when coupled to the {N}avier-{S}tokes equations?},
    url = {https://doi.org/10.1007/s00030-019-0600-8},
    volume = {26},
    year = {2019}
   }

`The URL link to the source <ttps://doi.org/10.1007/s00030-019-0600-8}>`__
