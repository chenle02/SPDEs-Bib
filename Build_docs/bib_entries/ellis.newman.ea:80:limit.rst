...
.. code-block:: bibtex
   ...
   @article{ellis.newman.ea:80:limit,
     author        = {Ellis, Richard S. and Newman, Charles M. and Rosen, Jay S.},
     ...
     number        = {2},
     pages         = {153--169},
     title         = {Limit theorems for sums of dependent random variables occurring in statistical mechanics. {II}. {C}onditioning, multiple phases, and metastability},
