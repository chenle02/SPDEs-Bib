...
.. code-block:: bibtex
   ...
   @article{hu.nualart.ea:08:integral,
    ...
    number = {9},
    pages = {2507--2532},
    title = {Integral representation of renormalized self-intersection
   local times},
...
`The URL link to the source <ttps://doi.org/10.1016/j.jfa.2008.06.016}>`__
