...
.. code-block:: bibtex
   ...
   et Statistiques},
    ...
    number = {3},
    pages = {1203--1225},
    title = {Limit law of a second class particle in {TASEP} with
   non-random initial condition},
    url = {https://doi.org/10.1214/18-aihp916},
    volume = {55},
    year = {2019}
   }

`The URL link to the source <https://doi.org/10.1214/18-aihp916>`__
