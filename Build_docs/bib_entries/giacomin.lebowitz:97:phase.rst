...
.. code-block:: bibtex
   ...
   @article{giacomin.lebowitz:97:phase,
     ...
     number        = {1-2},
     pages         = {37--61},
     title         = {Phase segregation dynamics in particle systems with long range interactions. {I}. {M}acroscopic limits},
     url           = {https://doi.org/10.1007/BF02181479},
     volume        = {87},
     year          = {1997}
   }

`The URL link to the source <https://doi.org/10.1007/BF02181479>`__
