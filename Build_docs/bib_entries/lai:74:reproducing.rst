...
.. code-block:: bibtex
   ...
   Verwandte Gebiete},
    ...
    pages = {7--19},
    title = {Reproducing kernel {H}ilbert spaces and the law of the
   iterated logarithm for {G}aussian processes},
    url = {https://doi.org/10.1007/BF00533181},
    volume = {29},
    year = {1974}
   }

`The URL link to the source <https://doi.org/10.1007/BF00533181>`__
