...
.. code-block:: bibtex
   ...
   @article{winkler:20:boundedness,
     ...
     title         = {Boundedness in a two-dimensional {K}eller-{S}egel-{N}avier-{S}tokes system involving a rapidly diffusing repulsive signal},
     url           = {https://doi.org/10.1007/s00033-019-1232-x},
     volume        = {71},
     year          = {2020}
   }

`The URL link to the source <https://doi.org/10.1007/s00033-019-1232-x>`__
