mao.marion.ea:02:environmental
==============================
...
.. code-block:: bibtex
   ...
   @article{mao.marion.ea:02:environmental,
    ...
    number = {1},
    pages = {95--110},
    title = {Environmental {B}rownian noise suppresses explosions in
   population dynamics},
...
`The URL link to the source <https://doi.org/10.1016/S0304-4149(01)00126-0>`__
