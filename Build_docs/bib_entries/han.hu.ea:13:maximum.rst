...
.. code-block:: bibtex
   ...
   @article{han.hu.ea:13:maximum,
    ...
    number = {2},
    pages = {279--322},
    title = {Maximum principle for general controlled systems driven by
...
`The URL link to the source <https://doi.org/10.1007/s00245-012-9188-7>`__
