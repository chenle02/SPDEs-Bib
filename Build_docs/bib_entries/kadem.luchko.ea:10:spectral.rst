...
.. code-block:: bibtex
   ...
   @article{kadem.luchko.ea:10:spectral,
    ...
    number = {1},
    pages = {103--115},
    title = {Spectral method for solution of the fractional transport
   equation},
...
`The URL link to the source <ttps://doi.org/10.1016/S0034-4877(10)80026-6}>`__
