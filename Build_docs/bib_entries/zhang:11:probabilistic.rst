...
.. code-block:: bibtex
   ...
   @article{zhang:11:probabilistic,
    ...
    number = {4},
    pages = {1502--1527},
    title = {A probabilistic approach to {D}irichlet problems of
   semilinear elliptic {PDE}s with singular coefficients},
    url = {https://doi.org/10.1214/10-AOP591},
    volume = {39},
    year = {2011}
   }

`The URL link to the source <ttps://doi.org/10.1214/10-AOP591}>`__
