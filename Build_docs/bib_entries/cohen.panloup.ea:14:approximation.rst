cohen.panloup.ea:14:approximation
=================================
...
.. code-block:: bibtex
   ...
   @article{cohen.panloup.ea:14:approximation,
    ...
    number = {3},
    pages = {1197--1225},
    title = {Approximation of stationary solutions to {SDE}s driven by
...
`The URL link to the source <https://doi.org/10.1016/j.spa.2013.11.004>`__
