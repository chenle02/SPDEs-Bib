...
.. code-block:: bibtex
   ...
   @article{park.xiao.ea:20:uniform,
    ...
    number = {4},
    pages = {2213--2232},
    title = {Uniform dimension results for the inverse images of
...
`The URL link to the source <https://doi.org/10.1007/s10959-019-00956-3>`__
