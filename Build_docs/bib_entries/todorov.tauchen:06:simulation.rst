...
.. code-block:: bibtex
   ...
   @article{todorov.tauchen:06:simulation,
     ...
     number        = {4},
     pages         = {455--469},
     title         = {Simulation methods for {L}\'{e}vy-driven continuous-time autoregressive moving average ({CARMA}) stochastic volatility models},
