...
.. code-block:: bibtex
   ...
   de Math\'{e}matiques et de Physique Appliqu\'{e}es},
    ...
    number = {5},
    pages = {2555--2573},
    title = {Boundedness and decay enforced by quadratic degradation in
   a three-dimensional chemotaxis-fluid system},
    url = {https://doi.org/10.1007/s00033-015-0541-y},
    volume = {66},
    year = {2015}
   }

`The URL link to the source <ttps://doi.org/10.1007/s00033-015-0541-y}>`__
