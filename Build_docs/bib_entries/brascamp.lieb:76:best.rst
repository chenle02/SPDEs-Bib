...
.. code-block:: bibtex
   ...
   @article{brascamp.lieb:76:best,
    ...
    number = {2},
    pages = {151--173},
    title = {Best constants in {Y}oung's inequality, its converse, and
   its generalization to more than three functions},
    url = {https://doi.org/10.1016/0001-8708(76)90184-5},
    volume = {20},
    year = {1976}
   }

`The URL link to the source <https://doi.org/10.1016/0001-8708(76)90184-5>`__
