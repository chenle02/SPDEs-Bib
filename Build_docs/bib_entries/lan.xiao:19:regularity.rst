...
.. code-block:: bibtex
   ...
   @article{lan.xiao:19:regularity,
    ...
    number = {1},
    pages = {27--52},
    title = {Regularity properties of the solution to a stochastic heat
   equation driven by a fractional {G}aussian noise on
   {$\Bbb{S}^2$}},
...
`The URL link to the source <ttps://doi.org/10.1016/j.jmaa.2019.01.077}>`__
