...
.. code-block:: bibtex
   ...
   Computations},
    ...
    number = {3},
    pages = {714--745},
    title = {Existence and uniqueness for the mild solution of the
   stochastic heat equation with non-{L}ipschitz drift on an
...
`The URL link to the source <ttps://doi.org/10.1007/s40072-020-00182-7}>`__
