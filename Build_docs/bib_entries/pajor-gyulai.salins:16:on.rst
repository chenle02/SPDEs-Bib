...
.. code-block:: bibtex
   ...
   @article{pajor-gyulai.salins:16:on,
    ...
    number = {3},
    pages = {1083--1099},
    title = {On dynamical systems perturbed by a null-recurrent fast
   motion: the continuous coefficient case with independent
   driving noises},
...
`The URL link to the source <ttps://doi.org/10.1007/s10959-015-0600-5}>`__
