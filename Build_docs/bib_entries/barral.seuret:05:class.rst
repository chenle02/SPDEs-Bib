...
.. code-block:: bibtex
   ...
   @article{barral.seuret:05:class,
     ...
     number        = {9},
     pages         = {579--582},
     title         = {A class of multifractal semi-stable processes including {L}\'evy subordinators and {M}andelbrot multiplicative cascades},
     url           = {https://doi.org/10.1016/j.crma.2005.09.020},
     volume        = {341},
     year          = {2005}
   }
`The URL link to the source <https://doi.org/10.1016/j.crma.2005.09.020>`_
