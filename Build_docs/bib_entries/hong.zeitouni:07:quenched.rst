...
.. code-block:: bibtex
   ...
   @article{hong.zeitouni:07:quenched,
    ...
    number = {4},
    pages = {807--820},
    title = {A quenched {CLT} for super-{B}rownian motion with random
   immigration},
...
`The URL link to the source <https://doi.org/10.1007/s10959-007-0079-9>`__
