...
.. code-block:: bibtex
   ...
   et Statistiques},
    ...
    number = {1},
    pages = {358--388},
    title = {On comparison principle and strict positivity of solutions
   to the nonlinear stochastic fractional heat equations},
    url = {https://doi.org/10.1214/15-AIHP719},
    volume = {53},
    year = {2017}
   }

`The URL link to the source <ttps://doi.org/10.1214/15-AIHP719}>`__
