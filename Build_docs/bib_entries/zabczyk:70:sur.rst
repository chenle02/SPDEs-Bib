...
.. code-block:: bibtex
   ...
   Mathematica},
    ...
    pages = {227--247},
    title = {Sur la th\'{e}orie semi-classique du potentiel pour les
   processus \`a accroissements ind\'{e}pendants},
    url = {https://doi.org/10.4064/sm-35-3-227-247},
    volume = {35},
    year = {1970}
   }

`The URL link to the source <ttps://doi.org/10.4064/sm-35-3-227-247}>`__
